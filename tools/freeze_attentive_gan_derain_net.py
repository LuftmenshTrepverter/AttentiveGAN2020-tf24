...
input_tensor = tf.compat.v1.placeholder(dtype=tf.float32, shape=[1, 240, 360, 3], name='input_tensor')
...
tf.compat.v1.train.write_graph(converted_graph_def, './', 'attentive_gan_derain.pb', as_text=False)
